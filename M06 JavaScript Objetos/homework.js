...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var resu = 0;
   resu = objetoMisterioso.numeroMisterioso * 5;
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   var auxi = objetoUsuario.amigos;
   auxi.push(nuevoAmigo);
   objetoUsuario.amigos = auxi;
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for(var i = 0; i < objetoUsuario.posts.length; i++){
      ress = ress + objetoUsuario.posts[i].likes;
   }
   return ress;
}
